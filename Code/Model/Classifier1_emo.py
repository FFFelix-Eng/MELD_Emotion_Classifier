...
class BERTEmotionClassifier_utt_emo(nn.Module):
    def __init__(self, bert_model_name, hidden_dim, cache_dir, output_dim=7, freeze_bert=True):
        super(BERTEmotionClassifier_utt_emo, self).__init__()
